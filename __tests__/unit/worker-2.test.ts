import { CheckProcessorHealth } from "../../src/modules/worker-2/foreign/api-process-health.foreign";
import { ProcessmentApplication } from "../../src/modules/worker-2/application/processment.application";
import { memoryStore } from "../../src/modules/worker-2/store/index.store";

global.fetch = jest.fn();

jest.mock("../../src/modules/worker-2/store/index.store", () => ({
  memoryStore: {
    get: jest.fn(),
  },
}));
...
jest.mock("../../src/modules/worker-2/foreign/api-process-health.foreign", () => ({
